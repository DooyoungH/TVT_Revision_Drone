...
\begin{description}
	...
	\item \textit
	{
	R1: We are extremely grateful to the editor for handling our paper for the IEEE Transaction of Vehicular Technology. We added new references about handling the recent trends and adjusted Section I and Section II to fit the paper's volume, as suggested by Reviewer 3 and Reviewer 4.
	}
	~\\
	~\\
	\item \textbf
	...
	\item \textit
	{
	R2: We presented a scenario about the process of our drone’s task optimization and formulated the flight energy optimization problem of the drone in Subsection VI-A. 
    Furthermore, We described a solution to the optimization problem through algorithms in Subsection VI-C and VI-D.
    We modified Subsection IV-D to describe the contents of the wind sensor used for the power model configuration.
    We also presented a simulation environment to Subsection VI-B for our offline approach with sufficient fidelity to apply to the reality instead of the online planning.}
    ~\\
    ~\\
	\item \textbf
	{
